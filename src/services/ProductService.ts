...
export class ProductService{
    ...
    public async getProducts(){
        ...
        await this.productHttpClient?.getProducts().then((response) =>{
            result = response !== undefined ? JSON.parse(JSON.stringify(response)) : undefined;
            console.log(result);
            });
            return result;
    }
    ...
    public async getProductsByMaxPrice(sort:String = "maxRetailPrice"){
        let result:IProduct|undefined = undefined;
        await this.productHttpClient?.getProductsByMaxPrice(sort).then((response) =>{
            result = response !== undefined ? JSON.parse(JSON.stringify(response)) : undefined;
            console.log(result);
            });
            return result;
    ...
    public async getProductsByCategory(category:String = "Men"){
        let result:IProduct|undefined = undefined;
        await this.productHttpClient?.getProductsByCategory(category).then((response) =>{
            result = response !== undefined ? JSON.parse(JSON.stringify(response)) : undefined;
            console.log(result);
            });
            return result;
    ...
    public async getProductsBySortOrder(sort:String = "maxRetailPrice"){
        let result:IProduct|undefined = undefined;
        await this.productHttpClient?.getProductsBySortOrder(sort).then((response) =>{
            result = response !== undefined ? JSON.parse(JSON.stringify(response)) : undefined;
            console.log(result);
            });
            return result;
